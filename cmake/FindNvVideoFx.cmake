...
if(MSVC) 
    ADD_LIBRARY(NVVideoEffects SHARED ${NVMAXINE_DIR}/nvvfx/src/nvCVImageProxy.cpp)
    TARGET_LINK_LIBRARIES(NVVideoEffects PRIVATE "${VideoFX_LIB}")
else()
...
if(MSVC) 
    #ADD_LIBRARY(NVCVImage SHARED ${NVMAXINE_DIR}/nvvfx/src/nvCVImageProxy.cpp)
    #TARGET_LINK_LIBRARIES(NVCVImage PRIVATE "${NVCVImage_LIB}")
else()
...
IF(NVCVImage_LIB AND NVCVImage_INCLUDES AND 
  ...
  SET(NVMAXINE_LIBRARIES ${VideoFX_LIB} ${NVCVImage_LIB} 
...
if (NOT MSVC)
    SET(NVMAXINE_LIBRARIES ${NVMAXINE_LIBRARIES} NVCVImage)
endif()
